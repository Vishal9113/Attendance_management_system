...
class Attendance:
    ...
    def __init__(self, root):
        ...
        table_frame_right.place(x=710, y=50, width=740, height=500)
        ...
        search_entry.grid(row=0, column=7, padx=5, pady=10, sticky=W)
    ...
    def search_data(self):
        conn = mysql.connector.connect(host="localhost", username="root", password="root", database="face_recognition",port=3306)
