...
# This part is image labels setting start 
        ...
        img=img.resize((self.root.winfo_screenwidth(),130),Image.LANCZOS)
        self.photoimg=ImageTk.PhotoImage(img)

        # set image as lable
        f_lb1 = Label(self.root,image=self.photoimg)
        f_lb1.place(x=0,y=0,width=self.root.winfo_screenwidth(),height=130)
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"Images_GUI\irfan.jpg")
        ...
        std_b1_1 = Button(bg_img,text="MD IRFAN ANSARI \n Branch: CSE",cursor="hand2",font=("times new roman",15,"bold"),bg="white",fg="navyblue")
        std_b1_1.place(x=100,y=380,width=200,height=70)

        # Detect Face  button 2
        det_img_btn=Image.open(r"Images_GUI\nilesh.jpg")
        ...
        att_img_btn=Image.open(r"Images_GUI\uttam.png")
        ...
        att_b1_1 = Button(bg_img,text="UTTAM KR. RAJWAR \n Branch: CSE",cursor="hand2",font=("times new roman",13,"bold"),bg="white",fg="navyblue")
        att_b1_1.place(x=560,y=380,width=200,height=70)

         # Help  Support  button 4
        hlp_img_bt=Image.open(r"Images_GUI\vishal.jpg")
        ...
        hlp_img_btn=Image.open(r"Images_GUI\abhi.jpg")
