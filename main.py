...
# This part is image labels settingstart 
        ...
        img=img.resize((self.root.winfo_screenwidth(),140),Image.LANCZOS)
        self.photoimg=ImageTk.PhotoImage(img)

        # set image as lable
        f_lb1 = Label(self.root,image=self.photoimg)
        f_lb1.place(x=0,y=0,width=self.root.winfo_screenwidth(),height=100)

        # backgorund image 
        bg1=Image.open(r"Images_GUI\bg3.jpg")
        bg1=bg1.resize((self.root.winfo_screenwidth(),768),Image.LANCZOS)
        self.photobg1=ImageTk.PhotoImage(bg1)

        # set image as lable
        bg_img = Label(self.root,image=self.photobg1)
        bg_img.place(x=0,y=100,width=self.root.winfo_screenwidth(),height=768)
        ...
        title_lb1.place(x=0,y=0,width=self.root.winfo_screenwidth(),height=45)
        ...
        std_b1.place(x=150,y=100,width=250,height=250)
        ...
        std_b1_1.place(x=150,y=310,width=250,height=40)
        ...
        det_b1.place(x=500,y=100,width=250,height=250)
        ...
        det_b1_1.place(x=500,y=310,width=250,height=40)
        ...
        att_b1.place(x=800,y=100,width=250,height=250)
        ...
        att_b1_1.place(x=800,y=310,width=250,height=40)

         # Help  Support  button 4
        hlp_img_btn=Image.open(r"Images_GUI\hlp.jpg")
        hlp_img_btn=hlp_img_btn.resize((250,250),Image.LANCZOS)
        self.hlp_img1=ImageTk.PhotoImage(hlp_img_btn)

        hlp_b1 = Button(bg_img,command=self.helpSupport,image=self.hlp_img1,cursor="hand2",)
        hlp_b1.place(x=1100,y=100,width=250,height=250)
        ...
        hlp_b1_1.place(x=1100,y=310,width=250,height=40)
        ...
        tra_img_btn=tra_img_btn.resize((250,250),Image.LANCZOS)
        self.tra_img1=ImageTk.PhotoImage(tra_img_btn)

        tra_b1 = Button(bg_img,command=self.train_pannels,image=self.tra_img1,cursor="hand2",)
        tra_b1.place(x=150,y=400,width=250,height=250)
