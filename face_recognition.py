...
class Face_Recognition:
    ...
    def send_email(self, recipient, subject, body):
        ...
        smtp_port = 465
        email_from = 'vk8434418897@gmail.com'
        email_password = 'ysxr lbvm sybe hrke'  # Replace with your App Password
        ...
        def draw_boundary(img, classifier, scaleFactor, minNeighbors, color, text, clf):
            ...
            for (x, y, w, h) in features:
                ...
                if confidence > 75:
                    ...
                    face_position = self.detect_position(x, w, img.shape[1])
                    if face_position == "entry":
                        self.mark_attendance_entry(student_id, roll_no, name, email)
                            
                    elif face_position == "exit":
    ...
    def detect_position(self, x, w, frame_width):
        mid_x = x + w // 2
